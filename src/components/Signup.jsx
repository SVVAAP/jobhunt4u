...
const Signup = () => {
  ...
  const sendOtpEmail = (otp_code) => {
    ...
    emailjs.send('service_6iar33a', 'template_be150gv', templateParams, 'nq0XIkYT4cuoYUKQI')
      .then((result) => {
  ...
  return (
    <div style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-teal-400">
        <div className="bg-sky-50 shadow-2xl p-8 rounded-3xl ring-1 ring-sky-700 w-full max-w-2xl transform transition duration-500 hover:scale-105" style={{ backgroundImage: `url(${card_bg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
