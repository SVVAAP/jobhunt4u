  ...
  <h3 className="text-center bg-blue text-white align-middle flex-1 justify-normal p-1">Employer - Dashboard</h3>
      <div className="max-w-screen-2xl container mx-auto xl:px-14 md:py-10 py-5 px-4">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
          <Link
          to="/post-job"
            className="rounded-lg bg-blue px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
           onClick={window.top}>
            Post a Job
          </Link>
          <a
